	...
	<div id="dashboard" class="container">
		...
		<div id="add_area" class="row">
			<div class="text-right">
				<a href="#addProject" data-toggle="modal" class="btn btn-primary" id="btnAddProject"><i class="glyphicon glyphicon-plus"></i> 	Create Project</a>
				<a href="#addClient" data-toggle="modal" class="btn btn-primary" id="btnAddClient"> <i class="glyphicon glyphicon-plus"></i> Add Client</a>
			</div>
		</div> <!--- end of add_area -->
								...
								<div class="accordion" id="accordion">
									...
									<div class="accordion-group">
										<div class="accordion-heading">
											<a class="accordion-toggle list-group-item noti-heading" data-toggle="collapse" data-parent="#accordion" href="#noti_detail">
